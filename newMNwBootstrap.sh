...
wget http://51.15.51.146/pacglobal_bootstrap_current-2020_03_30.tar.gz
...
echo "moving pacglobal.conf"
cd ~
mv .PACGlobal/pacglobal.conf .

tar xvzf pacglobal_bootstrap_current-2020_03_30.tar.gz
rm pacglobal_bootstrap_current-2020_03_30.tar.gz
